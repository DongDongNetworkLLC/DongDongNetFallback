...
import com.dongdongnetwork.punishment.bungee.event.PunishmentEvent;
import com.dongdongnetwork.punishment.bungee.event.RevokePunishmentEvent;
import com.dongdongnetwork.punishment.bungee.listener.CommandReceiverBungee;
import com.dongdongnetwork.punishment.bungee.utils.CloudNetCloudPermsOfflineUser;
import com.dongdongnetwork.punishment.bungee.utils.LuckPermsOfflineUser;
...
public class BungeeMethods implements MethodInterface {
    ...
    public BungeeMethods() {
        if (ProxyServer.getInstance().getPluginManager().getPlugin("LuckPerms") != null) {
            ...
            log("Offline permission support through LuckPerms active");
            ...
            log("Offline permission support through CloudNet-CloudPerms active");
        } else {
            permissionableGenerator = null;

            log("No offline permission support through LuckPerms or CloudNet-CloudPerms");
        }
    }
    @Override
    ...
    public void kickPlayer(String player, String reason) {
        if(BungeeMain.getCloudSupport() != null){
            ...
            RedisBungee.getApi().sendChannelMessage("dongdongpunishment:main", "kick " + player + " " + reason);
        } else {
    ...
    public void notify(String perm, List<String> notification) {
        if (Universal.isRedis()) {
            notification.forEach((str) -> RedisBungee.getApi().sendChannelMessage("dongdongpunishment:main", "notification " + perm + " " + str));
        } else {
