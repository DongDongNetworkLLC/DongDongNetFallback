...
public class Punishment {
    ...
    public String getDate(long date) {
        SimpleDateFormat format = new SimpleDateFormat(mi.getString(mi.getConfig(), "DateFormat", "yyyy/MM/ss HH:mm"));
    ...
    private void announce(int cWarnings) {
        ...
        mi.notify("dongdong.punish.notify." + getType().getName(), notification);
    }
    ...
    public void delete(String who, boolean massClear, boolean removeCache) {
        ...
        if (who != null) {
            ...
            mi.notify("dongdong.punish.undoNotify." + getType().getBasic().getName(), Collections.singletonList(message));
